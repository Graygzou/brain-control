...
public class EnemyAStar : MonoBehaviour {
	...
	public class MySolver<GridNode, TUserContext> : SettlersEngine.AStarAlgorithm<GridNode, 
	TUserContext> where GridNode : SettlersEngine.IPathNode<TUserContext>
	{
		protected override Double Heuristic(PathNode inStart, PathNode inEnd)
		{


            int formula = 1;//GameManager.distance;
		...
		public MySolver(GridNode[,] inGrid)
			: base(inGrid)
		{
		}
	} 
	...
	void Start () {
		...
		MySolver<GridNode, System.Object> aStar = new MySolver<GridNode, System.Object>(Game.grid);
		IEnumerable<GridNode> path = aStar.Search(new Vector2(startGridPosition.x, startGridPosition.y), new Vector2(endGridPosition.x, endGridPosition.y), null);
	...
	public void findUpdatedPath(int currentX,int currentY)
	{
		...
		MySolver<GridNode, System.Object> aStar = new MySolver<GridNode, System.Object>(Game.grid);
		IEnumerable<GridNode> path = aStar.Search(new Vector2(currentX, currentY), new Vector2(endGridPosition.x, endGridPosition.y), null);
