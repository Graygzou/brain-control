...
public class Enemy : MovingObject
{
    ...
    public override void Death()
    {
        ...
        // Active a deadbody sprite at the enemy position.
        currentDeadBody = gameObject.transform.parent.GetChild(1).gameObject;
        currentDeadBody.transform.position = gameObject.transform.position;
        currentDeadBody.SetActive(true);
    }
    ...
    public override void Revive(int team)
    {
        ...
        currentDeadBody.SetActive(false);
